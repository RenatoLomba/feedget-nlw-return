  ...
  return (
    <>
      ...
      <div className="flex flex-col items-center py-10 w-[304px]">
        ...
        <button
          type="button"
          onClick={onSendAnotherFeedbackClick}
          className="
          bg-zinc-800 py-2 px-6 mt-6 rounded-md transition-colors
          hover:bg-zinc-700 border-transparent text-sm leading-6
